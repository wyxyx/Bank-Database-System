...
namespace CppCLR_Winforms1 {
	...
	/// SearchForm1 摘要
	/// </summary>
	public ref class SearchForm1 : public System::Windows::Forms::Form
	{
	public:
		SearchForm1(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &SearchForm1::button1_Click);
			// 
			// label1
			// 
			...
			this->Name = L"SearchForm1";
			this->Text = L"SearchForm1";
		...
		private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
			...
			try {
				...
				if (count == 1) {
					...
					SearchForm2^ f = gcnew SearchForm2();
