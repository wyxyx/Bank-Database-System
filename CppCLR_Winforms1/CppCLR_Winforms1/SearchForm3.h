...
namespace CppCLR_Winforms1 {
	...
	/// SearchForm3 摘要
	/// </summary>
	public ref class SearchForm3 : public System::Windows::Forms::Form
	{
	public:
		SearchForm3(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &SearchForm3::button1_Click);
			// 
			// label1
			// 
			...
			this->Name = L"SearchForm3";
			this->Text = L"SearchForm3";
		...
		private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
			...
			try {
				...
				if (count == 1) {
					...
					SearchForm4^ f = gcnew SearchForm4();
